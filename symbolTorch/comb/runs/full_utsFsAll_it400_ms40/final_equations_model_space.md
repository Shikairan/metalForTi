...
```text
L = 0.8350171 + (0.040941132)*Al + (-0.061953447)*Zr + (0.061819415)*Sn + (-0.0061552604)*Mo + (0.01924617)*Cr + (-0.0064078769)*Nb + (0.18028176)*el_Si + (-0.0068071535)*V + (-0.15113067)*Ta + (0.0061799585)*Fe + (-0.1446218)*tem + (0.031604143)*fcr + (0.12368723)*coldway_0 + (0.081631698)*coldway_1 + (-0.18830134)*coldway_2 + (0.014543702)*coldway_3 + (-0.26801711)*coldway_4 + (0.014773195)*coldway_5 + (-1e-06)*coldway_6 + (1e-06)*coldway_7 + (-0.10684088)*coldway_8 + (-0.0069426307)*coldway_9 + (-0.60072438)*coldway_10 + (-0.027783996)*coldway_11 + (0.0017458583)*coldway_12 + (-0.020902644)*coldway_13 + (-0.42680002)*coldway_14 + (-0.048078721)*coldway_15 + (1e-06)*coldway_16 + (1e-06)*coldway_17
```
